...
<script>
        ...
        function sniff() {
            ...
            for (var e, i = !1, s = navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/iPhone|iPad|iPod/i) || navigator.userAgent.match(/Opera Mini/i) || navigator.userAgent.match(/IEMobile/i) || null, o = navigator.appName, n = navigator.userAgent, t = n.match(/(opera|chrome|safari|firefox|msie|trident|edge)\/?\s*(\.?\d+(\.\d+)*)/i), r = n.match(/(opera|chrome|safari|firefox|msie|trident|edge)\/?\s*(\.?\d+(\.\d+)*)/gi), a = 0; a < r.length; a++)
                ...
                if ("trident" == t[0].toLowerCase()) {
                    m = "msie", console.log(n), f = n.match(/(rv)\:?(\.?\d+(\.\d+)*)/i);
	...
	<link type="text/css" media="screen" rel="stylesheet" href="maintenance_assets/css/style5ed9.css" >
    <link type="text/css" media="print" rel="stylesheet" href="maintenance_assets/css/print-min.css" >
...
<div class="hero-detail"></div>
    ...
    <footer>
        ...
        <div class="visually-hidden" role="region" id="hidden-aria-alerts-polite" aria-live="polite"></div>
        <div class="visually-hidden" role="region" id="hidden-aria-alerts-assertive" aria-live="assertive"></div>
...
<div class="footer-detailing-front">
</div>
        ...
        <script type="text/javascript" src="maintenance_assets/js/main-extrasd8ae.js"></script>
        <script type="text/javascript" src="maintenance_assets/js/main-minf231.js"></script>
