...
const fetchUsers = async () => {
    ...
    try {
        const response = await axios.get(
            route("admin.users.api", { search: searchTerm.value })
        ); // Use route() helper
...
watch(
    ...
    { immediate: true }
); // Run immediately if selectedUser has an initial value
...
const fetchArtists = async () => {
    ...
    try {
        const response = await axios.get(
            route("admin.artists.api", { search: artistSearchTerm.value })
        );
...
watch(
    ...
    (newArtist) => {
        if (newArtist) {
            ...
            artistEditForm.social_links = newArtist.social_links
                ? newArtist.social_links.join(", ")
                : "";
    ...
    { immediate: true }
); // Run immediately if selectedArtist has an initial value
...
const generateSlug = debounce(() => {
    if (artistEditForm.name) {
        ...
        artistEditForm.slug = artistEditForm.name
            .toLowerCase()
...
const submitArtistUpdate = () => {
    ...
    artistEditForm.patch(
        route(routeName, { artist: selectedArtist.value.id }),
        {
            data: {
                ...artistEditForm.data(),
...
watch(
    ...
    { immediate: true }
); // Run immediately if selectedStage has an initial value
    ...
    <MainLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                >
                    <div
                        v-if="currentAdminView === 'dashboard'"
                        key="dashboard-view"
                    >
                        <div
                        ...
                        >
                            ...
                            >
                                <div class="flex items-center">
                                    <div
                                        class="p-3 rounded-full bg-cyan-500/20"
                                    >
                                        <svg
                            ...
                            >
                                <div class="flex items-center">
                                    <div
                                        class="p-3 rounded-full bg-purple-500/20"
                                    >
                                        <svg
                            ...
                            >
                                <div class="flex items-center">
                                    <div
                                        class="p-3 rounded-full bg-orange-500/20"
                                    >
                                        <svg
                            ...
                            >
                                <div class="flex items-center">
                                    <div
                                        class="p-3 rounded-full bg-green-500/20"
                                    >
                                        <svg
                    ...
                    <div
                        v-else-if="currentAdminView === 'userList'"
                        key="user-list-view"
                    >
                        <div
                            class="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl p-6"
                            ...
                            >
                                ...
                                <div v-else class="space-y-4">
                                    ...
                                    >
                                        <div class="flex items-center">
                                            <div
                                                class="p-2 rounded-full bg-cyan-500/20"
                                            >
                                                <svg
                                                    class="w-5 h-5 text-cyan-400"
                                                    fill="currentColor"
                    ...
                    <div
                        v-else-if="currentAdminView === 'userEdit'"
                        key="user-edit-view"
                    >
                        <div
                            class="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl p-6"
                            ...
                            >
                                ...
                                <div v-else class="space-y-4">
                                    ...
                                    >
                                        <div class="flex items-center">
                                            <div
                                                class="p-2 rounded-full bg-purple-500/20"
                                            >
                                                <svg
                                                    class="w-5 h-5 text-purple-400"
                                                    fill="currentColor"
                    ...
                    <div
                        v-else-if="currentAdminView === 'artistEdit'"
                        key="artist-edit-view"
                    >
                        <div
                            class="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl p-6"
                        >
                            ...
                            <!-- Artist Edit Form -->
                            <form
                                @submit.prevent="submitArtistUpdate"
                                class="space-y-4"
                            >
                                <!-- Name Field -->
                                <div>
                                    ...
                                    >
                                        <div
                                            v-if="artistEditForm.errors.name"
                                            class="mt-1 text-sm text-red-400"
                                        >
                                            {{ artistEditForm.errors.name }}
                                        </div>
                                    </Transition>
                                </div>
                                ...
                                <div>
                                    ...
                                    >
                                        <div
                                            v-if="artistEditForm.errors.slug"
                                            class="mt-1 text-sm text-red-400"
                                        >
                                            {{ artistEditForm.errors.slug }}
                                        </div>
                                    </Transition>
                                </div>
                                ...
                                <div>
                                    ...
                                    >
                                        <div
                                            v-if="artistEditForm.errors.genre"
                                            class="mt-1 text-sm text-red-400"
                                        >
                                            {{ artistEditForm.errors.genre }}
                                        </div>
                                    </Transition>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-400">
                                        Optional: Link to artist's profile image
                                        or promotional photo
                                    </p>
                                    <Transition
                                        enter-active-class="duration-200 ease-out"
                                        enter-from-class="opacity-0 translate-y-1"
                                    ...
                                    >
                                        <div
                                            v-if="
                                                artistEditForm.errors.image_url
                                            "
                                            class="mt-1 text-sm text-red-400"
                                        >
                                            {{
                            ...
                            >
                                ...
                                <div v-else class="space-y-4">
                                    ...
                                    >
                                        <div class="flex items-center">
                                            <div
                                                class="p-2 rounded-full bg-green-500/20"
                                            >
                                                <svg
                                                    class="w-5 h-5 text-green-400"
                                                    fill="currentColor"
                    ...
                    >
                        ...
                        >
                            ...
                            <!-- Stage Edit Form -->
                            <form
                                @submit.prevent="submitStageUpdate"
                                class="space-y-4"
                            >
                                <!-- Name Field -->
                                <div>
